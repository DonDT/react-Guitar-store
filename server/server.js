...
// By Arrival
// /artices?sortBy=createdAt&order=desc&limit=4

// By Sell
// /ariticles?sortBy=sold&order=desc&limit=4
...
app.get("/api/users/removeimage", auth, admin, (req, res) => {
  let image_id = req.query.publc_id;
...
app.post("/api/users/successBuy", auth, (req, res) => {
  ...
  // Saving require info into user history
    ...
    (err, user) => {
      ...
      payment.save((err, doc) => {
        ...
        doc.product.forEach(item => {
          products.push({ it: item.id, quantity: item.quantity });
        });
